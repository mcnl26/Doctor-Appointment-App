  ...
  return (
        ...
        <div className="d-flex justify-content-around">
          ...
          <div className="d-flex mt-5 opacity-75">
            <div className="mt-3 me-1" style={{ fontSize: "30px" }}>
              <i class="ri-mail-line border border-dark rounded-circle p-2"></i>
            </div>
            <div>
          ...
          <div className="d-flex mt-5  opacity-75">
            <div className="mt-3 me-1" style={{ fontSize: "30px" }}>
              <i class="ri-phone-line border border-dark rounded-circle p-2"></i>
            </div>
            <div>
    ...
    <div className="container d-flex justify-content-center mt-5">
        <div className="border p-4 text-white col-4" style={{ backgroundColor: "#43918f" }}>
          <div className="fs-1"><i class="ri-user-line"></i></div>
        ...
        <div className="border p-4 text-white col-4" style={{ backgroundColor: "#54b0ad" }}>
          <div className="fs-1"><i class="ri-hospital-line"></i></div>
        ...
        <div className="border p-4 text-white col-4" style={{ backgroundColor: "#4ed4cf" }}>
          <div className="fs-1"><i class="ri-calendar-check-line"></i></div>
    ...
    <div className="mt-5 container">
        ...
        <div className="ms-5 row d-flex justify-content-around mt-5">
            <div className="col-3">
                <div className="fs-1"><i class="ri-checkbox-circle-line"></i></div>
                <h2>Cardiology</h2>
